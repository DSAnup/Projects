...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?= base_url() . 'admin_file/admin/' ?>plugins/iCheck/flat/blue.css">
    <!-- Morris chart -->
    <link rel="stylesheet" href="<?= base_url() . 'admin_file/admin/' ?>plugins/morris/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="<?= base_url() . 'admin_file/admin/' ?>plugins/jvectormap/jquery-jvectormap-1.2.2.css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="<?= base_url() . 'admin_file/admin/' ?>plugins/datepicker/datepicker3.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="<?= base_url() . 'admin_file/admin/' ?>plugins/daterangepicker/daterangepicker.css">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="<?= base_url() . 'admin_file/admin/' ?>plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
    <script src="<?= base_url() . 'admin_file/admin/' ?>plugins/jQuery/jquery-2.2.3.min.js"></script>
    <link rel="stylesheet" href="<?= base_url() . 'admin_file/' ?>style.css">
