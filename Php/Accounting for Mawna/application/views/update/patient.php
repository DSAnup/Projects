...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?= base_url().'admin_file/patient/'?>css/bootstrap.min.css">
  ...
  <body>
    ...
    <form action="<?=base_url()?>Update_Control/addNewPatient" method="post" enctype="multipart/form-data">
      <div class="container" style="margin-top: 50px;background: #3333;padding: 20px 20px;">
        <div class="row">
          <div class="col-md-4">
              ...
              <div class="col-sm-12">
                <div class="row">
                  <div class="col-sm-4 form-group">
                    ...
                    <input type="text" class="form-control" required name="patientName">
                  </div>
                  <div class="col-sm-4 form-group">
                    <label>Age:</label>
...
<!--                     <label class="checkbox-inline"><input type="radio" name="indoor-outdoor">Normal</label>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3 form-group">
                    ...
                    <div class='input-group date' id='datetimepicker1'>
                      <input type='text' name="lastFollow" class="form-control" />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12 form-group">
                    ...
                    <textarea  rows="3" class="form-control" name="diagnosis" ></textarea>
