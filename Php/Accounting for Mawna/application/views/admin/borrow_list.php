  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url() . 'Control/admin_list' ?>">Borrow List </a></li>
      ...
      <div class="row">
        <div class="box">
          <div class="box-body">
            ...
            <form action="<?=base_url()?>Control/add_borrow" method="post" enctype="multipart/form-data">
              ...
              <table id="example1" class="table table-bordered table-striped" border="1">
                ...
                <tbody id="itembody">
                  ...
                  <tr>
                    ...
                    <td><?=$s->cheque?></td>
                    <td>
                      <a class="btn btn-sm btn-success" href="<?=base_url().'Control/borrow/'.$s->id?>">Edit</a>
                      <a class="btn btn-sm btn-danger" href="<?=base_url().'Control/delete_borrow/'.$s->id?>" onclick="return confirm('are you sure?')">Delete</a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
