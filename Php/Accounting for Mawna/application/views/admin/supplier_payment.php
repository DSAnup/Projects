              ...
              <div class="col-xs-12 col-md-12">
                <div class="col-md-10 col-md-offset-1">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="supplierID" onchange="get_supplier_due_info(this.value)">>
                  ...
                  <div class="form-group">
                    <label>Cash</label>
                    <input type="text" id="cash" class="form-control" value="0" onkeyup="calculate_due()" name="cash">
                  </div>
                  <div class="form-group">
                    <label>Cheque</label>
