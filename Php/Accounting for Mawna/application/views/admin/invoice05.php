            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="money_rec_top">
                  <p style="font-size: 40px; font-weight: 600;padding-bottom: 10px;color: red;letter-spacing: 5px;">মাওয়া ডায়াবেটিস সমিতি</p>
                  <p style="font-size: 40px; font-weight: 600;text-transform: uppercase;padding-left: 10px;">Mawna Diabetics Somiti</p>
                  <p style="font-size: 20px; font-weight: 400;text-transform: uppercase;line-height: 1; margin-bottom: 0; padding-bottom: 0;">মাওনা ডায়াবেটিক সমিতি ওয়েলফেয়ার ট্রাস্টের একটি সহযোগী প্রতিষ্ঠান</p>
 ...
 .invoice_right_logo img {
    ...
    margin-right: 50px;
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="table_one">
                  <table style="width:100% color:red; font-size: 17px;">
                    <tr>
                      <td style="font-size: 17px;">Invoice No</td>
                    ...
                    <tr style="font-size: 17px;">
                      <td>Patient Name</td>
                      <td>:<span class="padding_right"></span><?= $patient->patientName;?></td>
                    </tr>
                    <tr style="font-size: 17px;">
                      <td>Patient Age</td>
                  ...
                  <td>:<span class="padding_right"></span>
                    <?php if($patient->grnNum !=0){echo "GRN-000".$patient->grnNum;}?><?php if($patient->mrnNum !=0){echo "MRN-000".$patient->mrnNum;}?><?php if($patient->prnNum !=0){echo "PRN-000".$patient->prnNum;}?>
                  </td>
                </tr>
                  </table>
                </div>
              ...
              <div class="col-md-6">
                ...
                <table style="width:100%;style="font-size: 17px;>
                  <tr style="font-size: 17px;">
                    <td>Inv Date & Time</td>
                    <td>:<span class="padding_right"></span>
                    <?php
                  ...
                  ?> <?= $edit[0]->time;?></td>
                    ...
                    <tr style="font-size: 17px;">
                      <td>Mobile</td>
                      <td>:<span class="padding_right"></span><?= $patient->mob1;?></td>
                    </tr>
            ...
            <div class="col-md-12">
              <div class="tabel_two">
                <table style="width:100%">
                  <tr style="border: 2px solid#ABB1BA;font-size: 17px;">
                  ...
                  <tr class="table_two_tr" style="font-size: 17px;">
                    <td></td>
                  ...
                  <tr class="table_two_tr" style="font-size: 17px;">
                    <td></td>
                    <td><span class="table_two_mid">Dicount :</span></td>
                ...
                <div class="inword_remark" style="font-size: 17px;">
                  <p>(Taka In word: <?= $gword;?> Only)</p>
                </div>
                <div class="posted_reamrk_del" style="font-size: 17px;">
                  <p>Posted By : <?= $posted->name;?></p>
                  <!--<p>Remarks: Due by Mawya General Hospital</p>-->
                  <!--<p>Delivery After: 36 Hours </p>-->
                </div>
                <p style="font-size:16px;font-weight:bold;text-align:center;padding-bottom: 0; margin-bottom: 0;">(একটি অলাভজনক সমাজসেবামূলক স্বাস্থ্য প্রতিষ্ঠান)                    </p>
              </div>
            </div>
          </div>
