  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url() . 'Control/admin_list' ?>">Add Admin </a></li>
              ...
              <table id="example1" class="table table-bordered table-striped" border="1">
                ...
                <tbody id="itembody">
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-sm <?php if($s->status=='active'){ echo 'btn-success';}else{ echo 'btn-danger';} ?>" href="<?=base_url().'Control/change_status/'.$s->id?>">
                        <?php if($s->status=='active'){ echo "Active"; }else{ echo 'Inactive'; };?>
                      </a>
                    </td>
                    <td>
                      <a class="btn btn-sm btn-success" href="<?=base_url().'Control/admin_list/'.$s->id?>">Edit</a>
                      <a class="btn btn-sm btn-danger" href="<?=base_url().'Control/delete_admin/'.$s->id?>" onclick="return confirm('are you sure?')">Delete</a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
      ...
      <div class="row">
        <div class="box">
          <div class="box-body">
            ...
            <form action="<?=base_url()?>Control/add_admin" method="post" enctype="multipart/form-data">
