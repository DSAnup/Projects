...
<body class="fp-page">
    <div class="fp-box">
        <div class="logo">
            <a href="javascript:void(0);"><b>Waps Solution</b></a>
            <!--<small>Waps Solution</small>-->
                <h6 style="background-color: lightgrey; color: red; text-align: center;"><?php echo $this->session->flashdata('item'); ?></h6>
        </div>
        <div class="card">
            <div class="body">
                <form id="forgot_password" method="POST" action="<?=base_url()?>Admin_panel/resetpassword">
                    <div class="msg">
                    ...
                    <button class="btn btn-block btn-lg bg-pink waves-effect" id="enter" type="submit">RESET MY PASSWORD</button>

                    <div class="row m-t-20 m-b--5 align-center">
                        <a href="<?= base_url().'Admin_panel'?>">Sign In!</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script src="<?= base_url().'admin_assets'?>/js/pages/examples/forgot-password.js"></script>
</body>
