                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form action="<?=base_url()?>Admin_panel/add_expense" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="userID" value="<?= $userID?>">
                                <div class="form-group form-float">
                                    <label class="form-label">Date</label>
                                    <div class="form-line" >
                                            <input type="date" name="exDate" class="form-control" placeholder="Please choose a date...">
                                        </div>
                                </div>
                                <div class="form-group form-float">
                              ...
                              <div class="form-group form-float">
                                    ...
                                    <div class="form-line" >
                                        <input type="text" name="exPurpose" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" id="email_address" name="exAmount" class="form-control" required="required">
                                ...
                                <br>
                                <button type="submit" class="btn btn-primary m-t-15 waves-effect">Add An Expenses</button>
                            </form>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a data-toggle="modal" data-target="#myModal-<?= $s->id;?>" href="javascript:void(0);">Update</a><a href="<?=base_url().'Admin_panel/delete_expense/'.$s->id?>" onclick="return confirm('are you sure?')" style="color:red">Delete</a></td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
                                </table>
