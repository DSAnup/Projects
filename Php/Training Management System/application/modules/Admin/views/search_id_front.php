        ...
        <div class="row">
            ...
            <div class="col-md-12" >
                <div class="panel" >
                    <div class="panel-heading">
                        <h3 class="panel-title">
                           Print Student's ID Card by Batch
                       </h3>
                ...
                <div class="panel-body" style="text-align: center;" >
                    <form action="<?=base_url().'Admin/front_side'?>" method="post">
                        <table class="table">
                            <tr>
                                <th>Select Batch</th>
                                <td>
                                    <select class="form-control" name="batch">
                                        ...
                                        foreach ($ba as $e) {
                                            ?>
                                            <option value="<?=$e->id?>"><?=$e->batch_name?></option>
                                            <?php } ?>
                                        </select>
                                    </td>
                                    <td><input type="submit" class="btn btn-success"  value="Show ID Card"></td>
                                </tr>
                            </table>
                        </form>
                    </div>
                ...
                <div class="panel" >
                    <div class="panel-heading">
                        <h3 class="panel-title">
                           Print Student's ID Card (Front Side) by Student ID
                       </h3>
                       <span class="pull-right">
                        <i class="fa fa-fw ti-angle-up clickable"></i>
                        <i class="fa fa-fw ti-close removepanel clickable"></i>
                ...
                <div class="panel-body" style="text-align: center;" >
                    <form action="<?=base_url().'Admin/front_side_by_id'?>" method="post">
                        <table class="table">
                            <tr>
                                <th>Enter Enrollment ID</th>
