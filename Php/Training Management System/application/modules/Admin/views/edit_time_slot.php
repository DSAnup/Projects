            ...
            <div class="col-md-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="<?=base_url().'Admin/update_schedule'?>" method="post" role="form" enctype="multipart/form-data">
                            <table class="table table-bordered dataTables">
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="days" value="<?=$days->days?>" class="form-control" placeholder="Enter Days Here"></td>
                                    </tr>
                                    <tr>
                                        <th>Time Slot</th>
                                        <td>
                                            <table class="table table-bordered" id="sh">
                                                ...
                                                <input type="hidden" name="slot_id" value="<?=$slot->id?>">
                                                    <td><input type="text" name="slot" class="form-control" placeholder="Enter Time Slots Here" value="<?=$slot->slot?>"></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
