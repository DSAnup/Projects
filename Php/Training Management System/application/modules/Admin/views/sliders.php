                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                        <i class="fa fa-fw ti-move"></i> Slider List
                                    </h3>
                                    ...
                                    <table class="table table-bordered datatable">
                                        ...
                                        <tbody>
                                            ...
                                            foreach($query as $q){
                                                ...
                                                <tr>
                                                    <td><?=++$i?></td>
                                                    <td><img src="<?=base_url().'sliders/'.$q->photo?>" height="150" width="200"></td>
                                                    <td><?=$q->main_caption?></td>
                                                    <td><?=$q->sub_caption?></td>
                                                    <td><?=$q->description?></td>
                                                    <td><?=$q->position?></td>
                                                    <td>
                                                        <a href="<?=base_url().'Admin/edit_slider/'.$q->id?>">Edit</a> / <a href="<?=base_url().'Admin/delete_slider/'.$q->id?>"  onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
