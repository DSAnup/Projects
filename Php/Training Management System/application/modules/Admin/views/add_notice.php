                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" enctype="multipart/form-data" action="<?=base_url().'Admin/notice_post'?>" method="post">
                                <div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Title</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="title" class="form-control" id="input-text" placeholder="Add Title  Here" required>
                                    </div>
                                </div>                                              
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-10">
                                        <textarea rows="8" name="description" class="form-control resize_vertical" placeholder="Description"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">
