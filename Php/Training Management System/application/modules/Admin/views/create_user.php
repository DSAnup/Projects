            ...
            <div class="col-md-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="<?=base_url().'Admin/add_user'?>" method="post" role="form" enctype="multipart/form-data">
                            <table class="table table-bordered dataTables">

                                <tr>
                                <th width="70px">User Name</th>
                                    <td><input type="text" class="form-control" name="name" placeholder="Inter Your User Name"></td>
                                </tr>
                                <tr>
                                    <th width="70px">Email</th>
                                    <td><input type="email" class="form-control" name="email"placeholder="Inter Your User email"></td>
                                </tr>

                                <tr>
                                    <th width="70px">Password</th>
                                    <td><input type="Password" class="form-control" name="password" placeholder="Inter Your User Password"></td>
                                </tr>
                        ...
                        <table class="table table-bordered datatable">
                            ...
                            ?>
                              <tr>
                                  ...
                                  <td><a href="<?=base_url().'Admin/edit_user/'.$e->id?>">Edit</a> / <a href="<?=base_url().'Admin/delete_user/'.$e->id?>" style="color: red">Delete</a></td>
                              </tr>
                              <?php }?>
