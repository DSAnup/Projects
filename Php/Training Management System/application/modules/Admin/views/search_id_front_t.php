        ...
        <div class="row">
            ...
            <div class="col-md-12" >
                ...
                <div class="panel" >
                    <div class="panel-heading">
                        <h3 class="panel-title">
                         Print Instructor's ID Card (Front Side) by Instructor's ID
                     </h3>
                ...
                <div class="panel-body" style="text-align: center;" >
                    <form action="<?=base_url().'Admin/front_side_by_id_t'?>" method="post">
                        <table class="table">
                            <tr>
                                <th>Enter Instructor,s ID</th>
                                <td>
                                    <input type="text" name="id" class="form-control">
                                </td>
                                <th>Enter Driving Licence ID</th>
                                <td>
