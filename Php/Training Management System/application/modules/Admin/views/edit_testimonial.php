                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" action="<?=base_url().'Admin/edit_testimonial_post'?>" method="post" role="form" enctype="multipart/form-data">
                                <table class="table table-bordered dataTables">
                                  
                                        <tr>
                                            <th width="70px">Name</th>
                                            <td><input type="text" value="<?=$q->name?>" class="form-control" name="name"></td>
                                        </tr>
                                        <tr>
                                            <th width="70px">Designation</th>
                                            <td><input type="text" value="<?=$q->designation?>" class="form-control" name="designation"></td>
                                        </tr>
                                        <tr>
                                            <th width="70px">Photo</th>
                                            <td>
                                            <img src="<?=base_url().'testimonial_photo/'.$q->photo?>" width="50" height="55">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea name="msg" cols="5" rows="5" class="form-control"><?=$q->msg?></textarea>
