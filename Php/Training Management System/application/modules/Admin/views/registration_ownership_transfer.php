...
<input type="hidden" id="check">
                ...
                <form action="<?=base_url().'Admin/ownership_transfer_registration'?>" method="post" enctype="multipart/form-data" id="f">
                  <div class="col-md-12">
                    <div class="col-md-12">
                      ...
                      <span id="frm">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="serial" name="serial" id="serial" onkeyup="get_std_id(this.value)">
                        </div>
                      </div>
                        <div class="form-group col-md-6">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control" name="existing_owner">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control" name="veh_reg_no">
                        </div>
                        <div class="form-group col-md-6">
                          <label>TAX TOKEN EXPIRY DATE</label>
                          <input type="date" class="form-control" name="veh_tax_exp_date">
                        </div>
                        <div class="form-group col-md-6">
                          <label>FITNESS EXPIRY DATE</label>
                          <input type="date" class="form-control" name="veh_fitness_date">
                        </div>
                        <div class="form-group col-md-6">
                          <label>INSURANCE EXPIRY DATE</label>
                          <input type="date" class="form-control" name="veh_ins_exp_date">
                        </div>
                        <div class="form-group col-md-6">
                          <label> ENGINE NO</label>
                          <input type="text" class="form-control" name="veh_eng_no">
                        </div>
                        <div class="form-group col-md-6">
                          <label> CHASIS NO</label>
                          <input type="text" class="form-control" name="veh_chasis_no">
                        </div>
                        <div class="form-group col-md-12">
                          <label> ACCIDENTAL HISTORY</label>
                          <textarea class="form-control" name="veh_accident_history"></textarea>
                        </div>
                      ...
                      <div class="col-md-12">
                       ...
                       <div class="form-group col-md-6"> 
                        ...
                        <input type="date" class="form-control" name="veh_app_date">
                      </div>
                      <div class="form-group col-md-6"> 
                        <label>TEMPORARY R/C ISSUE/EXPIRY DATE :</label>
                        <input type="date" class="form-control" name="veh_tmp_rc">
                      </div>
                      <div class="form-group col-md-6"> 
                        <label>BIOMETRIC PHOTO & FINGERPRINT DATE :</label>
                        <input type="date" class="form-control" name="veh_bio_date">
                      </div>
                      <div class="form-group col-md-6"> 
                        <label>DATE OF VEHICLES R/C DELIVERY :</label>
                        <input type="date" class="form-control" name="veh_rc_date">
                      </div>
                    </div>
