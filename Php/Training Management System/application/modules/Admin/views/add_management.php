                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw ti-move"></i> ADD MANAGEMENT PERSONEL
                            </h3>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" action="<?=base_url().'Admin/add_management_post'?>" method="post" role="form" enctype="multipart/form-data">
