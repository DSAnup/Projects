                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" enctype="multipart/form-data" action="<?=base_url().'Admin/job_edit'?>" method="post">
                                <div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Post Title</label>
                                    <div class="col-sm-10">
                                    <input type="hidden" name="id" value="<?=$query->id?>">
                                        <input type="text" name="post" value="<?=$query->post?>" class="form-control" id="input-text" placeholder="Add Title  Here" required>
                                    </div>
                                </div>  
                                <div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Vacancy</label>
                                    <div class="col-sm-10">
                                        <input type="text" value="<?=$query->vacancy?>" name="vacancy" class="form-control" id="input-text" placeholder="Add Title  Here" required>
                                    </div>
                                </div>                                            
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-10">
                                        <textarea rows="8" name="details" class="form-control resize_vertical" placeholder="Description"><?=$query->details?></textarea>
                                    </div>
                                </div>
