...
$(document).ready(function () {
	...
	$(".navigation nav li a").each(
		...
		//hamid group home menu
		            $('#hg_menu_container').hover(
                    function () {
						if($(window).width() < 500) {
                        	$('.hgNav').stop().animate({ 'opacity':'1','left':'-20px'},500)
						}else {
							$('.hgNav').stop().animate({ 'opacity':'1','left':'-110px'},500)
						}
                    },
                    function () {
                        $('.hgNav').stop().animate({ 'opacity':'0','left':'-510px'},500)
                    }
                );
	...
	$('.flexslider').flexslider({
		...
		start: function(slider) {
         ...
         $('.flexslider .slides').find('.flex-caption').animate({bottom:"0px", opacity:"1"}).delay(0);
      },
		after: function(slider) {
         // animate your caption ... 
         // find the item that is the current slide's .slidecaption and animate it
         $('.flexslider .slides').find('.flex-caption').animate({bottom:"0px", opacity:"1"}).delay(1600);
      },
	  before: function(slider) {
         // animate your caption ... 
         // find the item that is the current slide's .slidecaption and animate it
         $('.flexslider .slides').find('.flex-caption').animate({bottom:"-20px", opacity:"0"}).delay(1600);
      }
