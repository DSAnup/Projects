...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?=base_url().'admin_file/admin/'?>plugins/iCheck/square/blue.css">
...
<!--        <a href="#">I forgot my password</a><br>-->
        <!--<a href="<?=base_url().'Admin_panel/signup/'?>" class="text-center">Register a new membership</a><br>-->
...
<!-- iCheck -->
<script src="<?=base_url().'admin_file/admin/'?>plugins/iCheck/icheck.min.js"></script>
<script>
    $(function () {
        $('input').iCheck({
